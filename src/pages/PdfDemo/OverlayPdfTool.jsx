...
const OverlayPdfTool = () => {
  ...
  const handleMergeClick = async () => {
    ...
    if (data.length >= 2) {
      ...
      sendMergeRequest({ overlay_data: fileDataArray,start_page:formData.start_page });
    } else {
  ...
  const sendMergeRequest = (data_post) => {
    setLoading(true, 'Overlaying Please Wait....');
    const subscription = post('pdf/overlay_pdf', data_post).subscribe((response) => {
      setLoading(false);
      showNotification("success", "Overlay Completed Successfully");
      setResult(true);
      ...
      <div class="card">
        <div className="card-upload">
          ...
          <div className="content">
            <div className="field">
              <label className="label">Starting Page Number</label>              
